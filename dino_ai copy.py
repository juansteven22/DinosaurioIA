...
# Jugar una partida final con el mejor cerebro
pygame.init()
final_dino = Dino((255, 0, 0))
final_score = game([final_dino], [best_brain])[0]

print(f"\nMejor puntuación durante el entrenamiento: {best_score}")
print(f"Puntuación final con el mejor cerebro: {final_score}")
